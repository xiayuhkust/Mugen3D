...
public class UI_PartRowUI : MonoBehaviour, IPointerClickHandler, IPointerEnterHandler, IPointerExitHandler
{
    ...
    {
        if (m_baseUI != null) m_baseUI.PreviewPart(m_index);
    }
    ...
    private void ButtonRightClick()
    {
        ...
        if (m_baseUI != null) m_baseUI.TakeOnPart(m_index);
    }
}
